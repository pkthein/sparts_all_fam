...
def create_organization():
    ...
    try:
        ...
        output = category_cli.api_do_create_organization(request.json, config)    
...
def amend_organization():
    ...
    try:
        ...
        output = category_cli.api_do_amend_organization(request.json, config)    
...
def list_organization():
    ...
    try:
        output = category_cli.api_do_list_organization(config)
...
def retrieve_organization(organization_id):
    ...
    try:
        output = category_cli.api_do_retrieve_organization(organization_id, config)
...
def retrieve_organization_history(organization_id):
    ...
    try:
        output = category_cli.api_do_retrieve_organization(
