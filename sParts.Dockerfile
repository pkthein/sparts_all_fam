...
COPY ./phyo/tp_part_1.0/sawtooth_part/part-api.py /project/src/tp_part_1.0/sawtooth_part/part-api.py
COPY ./phyo/tp_organization_1.0/sparts_organization/organization-api.py /project/src/tp_organization_1.0/organization-api.py
COPY ./phyo/tp_artifact_1.0/sawtooth_artifact/artifact-api.py /project/src/tp_artifact_1.0/sawtooth_artifact/artifact-api.py
COPY ./phyo/tp_category_1.0/sawtooth_category/category-api.py /project/src/tp_category_1.0/sawtooth_category/category-api.py
